...
# A boolean flag to enable/disable DNS support in the VPC and it defaults True
variable "vpc_dns_support" {
  description = "Should DNS support to be enable for the VPC?"
  type        = bool
  default     = true
}

# A boolean flag to enable/disable DNS hostname in the VPC and it defaults true
variable "vpc_dns_hostnames" {
  description = "Should DNS hostnames support to be enabled for the VPC?"
  type        = bool
  default     = true
}
...
# A boolen flag to map public IP on launch for public subnets and it defaults true
variable "map_public_ip" {
  description = "Specify true to indicate that instances launced into the subnet should be assigned a public IP address"
  type        = bool
  default     = true
}
