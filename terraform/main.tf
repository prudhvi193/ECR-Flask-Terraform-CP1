      ...
      Statement = [
        {
          ...
          Resource = [
            ...
            "arn:aws:dynamodb:us-west-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
      ...
      Statement = [
        {
          ...
          Effect = "Allow"
          Resource = [
            "arn:aws:ecs:us-west-1:${local.account_id}:*/*",
            "arn:aws:cloudwatch:us-west-1:${local.account_id}:*/*"
          ]
        }
      ]
    })
...
resource "aws_ecs_service" "service" {
  ...
  task_definition = aws_ecs_task_definition.ecs_task_defintion.arn
...
resource "aws_dynamodb_table" "cricketers_table" {
