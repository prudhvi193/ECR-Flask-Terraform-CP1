# Retreive IAM policy documents for assuming roles. This is used to feed exclusive inline policies

# Create an IAM Policy for document for assumed roles for ECS Service
